# GEMINI.md - Agnostic Agent Rules
...
- Read `.agentic/context/global-context.md` for project context.
- Use shell tool to run `agentic-agent` commands.
- Run `agentic-agent validate` before marking tasks complete.

## Available Slash Commands
- `/prd` — Generate a Product Requirements Document
- `/ralph` — Convert a PRD to YAML task format
