...
> 
> This file contains GitHub Copilot-specific commands and workflow integration.
...
- Use inline completions for repetitive code patterns
- Leverage chat for architectural questions
- Use command palette for quick actions
- Reference `@workspace` for project-wide context
- Tag files with `#file:path` for focused assistance
